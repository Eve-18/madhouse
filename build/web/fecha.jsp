    ...
    <div class="card shadow-lg">
        ...
        <form action="FechaServlet" method="POST" id="formReserva">
            ...
            <div class="campo mb-3">
                ...
                <input type="date" name="fecha" id="fechaInput" value="<%= fechaActual %>" 
                       required onchange="recargarHoras()" class="form-control">
            </div>

            <label class="form-label">2. Selecciona la hora:</label>
            ...
            <!-- Botón Bootstrap -->
            <button type="submit" class="btn btn-dark w-100 mt-4">AGENDAR CITA</button>

            <div class="contenedor-volver text-center mt-3">
